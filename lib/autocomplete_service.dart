...
class GooglePlaceApiProvider implements PlaceApi {
  GooglePlaceApiProvider(this.sessionToken, this.apiKey);
...
class LocationIqApiProvider implements PlaceApi {
  LocationIqApiProvider(this.apiKey);
...
bool availablePlaceApi(String? googlePlaceApiKey, String? locationIqApiKey) {
  return googlePlaceApiKey != null || locationIqApiKey != null;
}

PlaceApi? createPlaceApi(String? googlePlaceApiKey, String? locationIqApiKey) {
  if (googlePlaceApiKey != null)
    return GooglePlaceApiProvider(Uuid().v4(), googlePlaceApiKey);
  if (locationIqApiKey != null) return LocationIqApiProvider(locationIqApiKey);
  return null;
}
